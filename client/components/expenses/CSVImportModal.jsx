                    ...
                    {step === 1 && (
                      <motion.div key="step1" variants={stepVariants} initial="initial" animate="animate" exit="exit" className="p-5 space-y-5">
                        <p className="text-sm text-slate-400">
                          Export your transactions from your bank's website as a CSV, then upload it here.
                        </p>

                        {/* Bank format selector */}
                        <div>
                          <p className="text-xs font-medium text-slate-400 uppercase tracking-wider mb-2">Bank Format</p>
                        ...
                        <div>
                          ...
                          >
                            ...
                            <div className="text-center">
                              <p className="text-sm text-slate-300 font-medium">Drop your CSV here or click to browse</p>
                    ...
                    {step === 2 && (
                      <motion.div key="step2" variants={stepVariants} initial="initial" animate="animate" exit="exit" className="flex flex-col">
                        <div className="px-5 pt-4 pb-2 flex items-center justify-between flex-shrink-0">
                          <p className="text-sm text-slate-400">
                            <span className="text-slate-100 font-semibold">{selectedCount}</span> of <span className="text-slate-100 font-semibold">{transactions.length}</span> transactions selected
                          </p>
                        </div>
                  ...
                  {step === 1 && (
                    <>
                      <p className="text-xs text-slate-500 flex items-center gap-1.5">
                        ...
                        Export CSV from your bank's website first
                      </p>
